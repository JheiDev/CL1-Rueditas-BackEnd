package pe.edu.cibertec.CL1_Rueditas_BackEnd.Service.Imp;
...
@Service
public class RueditasServiceImp implements RueditasService {

    @Autowired
    ResourceLoader resourceLoader;

    @Override
    public String[] validarPlaca(RueditasRequestDTO rueditasRequestDTO) throws IOException {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(resource.getFile()))) {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                if (rueditasRequestDTO.placa().equals(datos[1])) {
